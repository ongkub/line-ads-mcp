...
| Objective | Bidding แนะนำ | Budget ขั้นต่ำ/วัน |
|---|---|---|
| Friend Added | CPF Auto | ฿100 |
| Website Clicks | CPC Auto | ฿100 |
| Conversion | Target CPA (ถ้ามี tracking) / CPC | ฿300 |
| Reach | CPM Auto | ฿50 |
| App Install | CPC Auto | ฿100 |
| Video Views | CPV Auto | ฿50 |
